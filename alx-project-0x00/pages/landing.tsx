  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-12">
      ...
      <section className="mb-12">
        ...
        <div className="flex gap-4 flex-wrap">
          <Button title="Primary" className="bg-blue-600 text-white hover:bg-blue-700" />
          <Button title="Secondary" className="bg-gray-600 text-white hover:bg-gray-700" />
          <Button title="Success" className="bg-green-500 text-white hover:bg-green-600" />
          <Button title="Danger" className="bg-red-500 text-white hover:bg-red-600" />
        </div>
      </section>
